    ...
    <form class="form-horizontal" method="post" action="<?php echo site_url('master/tambah_barang')?>">
        <div class="modal-body">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="nm_barang" type="text" placeholder="Input Prod. Description...">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="ukuran" type="text" placeholder="Input Ukuran...">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="quality" type="text" placeholder="Input Kualitas...">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="type" type="text" placeholder="Input Type...">
                </div>
            </div>
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('master/edit_barang')?>">
                <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label class="control-label" >Ukuran</label>
                        <div class="controls">
                            <input name="ukuran" type="text" value="<?php echo $row->ukuran;?>" >
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label" >Kualitas</label>
                        <div class="controls">
                            <input name="kualitas" type="text" value="<?php echo $row->quality;?>" >
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label" >Type</label>
                        <div class="controls">
                            <input name="type" type="text" value="<?php echo $row->type;?>" >
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="total_kirim" type="text" value="<?php echo $row->total_kirim;?>">
                        </div>
                    </div>
