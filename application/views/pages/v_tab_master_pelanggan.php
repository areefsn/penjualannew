    ...
    <form class="form-horizontal" method="post" action="<?php echo site_url('master/tambah_pelanggan')?>">
        <div class="modal-body">
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="kd_pelanggan" type="text" placeholder="Input Kode Customer...">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="nm_pelanggan" type="text" placeholder="Input Nama Customer...">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="email" type="text" placeholder="Input NPWP..." >
                </div>
            </div>
        </div>
