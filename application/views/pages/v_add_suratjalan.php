...
<div class="well">
    <form>
        <label class="control-label">NO. CO</label>
        <div class="controls">
            <?php $this->db->query('SELECT kd_barang FROM tbl_penjualan_detail ORDER BY kd_barang DESC LIMIT 1');?>
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php foreach($this->cart->contents() as $items): ?>
                ...
                <tr class="gradeX">
                    ...
                    <td><?php echo $items['qual']; ?></td>
                    <td><?php echo $items['ty']; ?></td>
                    <td><?php echo $items['qty']; ?> Pcs</td>
    ...
    <form action="<?php echo site_url('penjualan/simpan_penjualan') ?>" method="post">
        ...
        <div class="controls">
            ...
            <input type="text" name="nm_sales" id="nm_sales">
                        ...
                        <select id="kd_pelanggan" tabindex="5" class="chzn-select" name="kd_pelanggan" data-placeholder="Pilih Pelanggan">
                            ...
                            if(isset($data_pelanggan)){
                                foreach($data_pelanggan as $row){
                                    ?>
                                    <option value="<?php echo $row->kd_pelanggan?>"><?php echo $row->kd_pelanggan?></option>
                                <?php
                                }
                            }
                            ?>
