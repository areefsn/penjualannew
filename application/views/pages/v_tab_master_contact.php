...
<form class="form-horizontal" method="post" action="<?php echo site_url('master/edit_contact')?>">
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="nama" type="text" value="<?php echo $row->nama?>" required maxlength="30">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="desc" type="text" value="<?php echo $row->desc?>" required maxlength="100">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="owner" type="text" value="<?php echo $row->owner?>" required maxlength="30">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-block-level" name="website" type="text" value="<?php echo $row->website?>" required maxlength="50">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <textarea class="span6" name="alamat" rows="5" required><?php echo $row->alamat?></textarea>
        </div>
    </div>
