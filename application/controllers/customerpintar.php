<?php
class Customerpintar extends CI_Controller{
    ...
    function index(){
        $data=array(
            'title'=>'Customer Pintar',
            'active_cust'=>'active',
            'data_penjualan'=>$this->model_app->CustPintar(),
        );
        $this->session->unset_userdata('tgl_awal');
        $this->session->unset_userdata('tgl_akhir');

        $this->load->view('element/v_header',$data);
        $this->load->view('pages/v_cust_pintar');
    ...
    function cari(){
        ...
        $data=array(
            'dt_result'=> $this->model_app->getCustPintar($tgl_awal,$tgl_akhir),
        ...
        $this->load->view('pages/v_result_customerpintar',$data);
    }
}
