...
class Penjualan extends CI_Controller{
    ...
    function index(){
        $data=array(
            ...
            'data_suratjalan'=>$this->model_app->allsj(),
        );
        $this->load->view('pages/v_suratjalan',$data);
...
//    GET DATA
    ...
    function detail_customerpintar(){
        $id= $this->uri->segment(3);
        $data=array(
            'title'=>'Detail Customer Pintar',
            'active_penjualan'=>'active',
            'dt_penjualan'=>$this->model_app->getDataPenjualan($id),
            'barang_jual'=>$this->model_app->getBarangPenjualan($id),
        );
        $this->load->view('element/v_header',$data);
        $this->load->view('pages/v_detail_order');
        $this->load->view('element/v_footer');
    }
...
//    INSERT DATA
    ...
    function simpan_penjualan(){
        $data = array(
            ...
            'tanggal_kirim'=>date("Y-m-d",strtotime($this->input->post('tanggal_kirim'))),
